...
public:
    ...
    void printByGender(char) const;
    bool find(const Type& searchItem) const;
...
template <class Type>
void doublyLinkedList<Type>::printByGender(char) const
{
...
template <class Type>
bool doublyLinkedList<Type>::find(const Type& searchItem) const
{
    bool found = false;
    nodeType<Type>* current; 
